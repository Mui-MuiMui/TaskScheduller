...
VSCode拡張機能として、Todoリスト、カンバンボード、ガントチャートの3つのビューでタスク管理を行うツールです。すべてのビューは同一データを共有し、リアルタイムで同期されます。

## 機能

### 3つの統合ビュー

- **Todoリスト**: チェックボックス付きのシンプルなタスク一覧、フィルタリング機能付き
- **カンバンボード**: ドラッグ&ドロップでタスクを管理（未着手 / 進行中 / 保留中 / 完了）
- **ガントチャート**: タイムライン表示、依存関係の矢印表示、進捗の可視化
